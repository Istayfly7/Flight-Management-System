...
public class ItineraryReservationsRepositoryTests {
	...
	@Test
	//@Rollback(false)
	public void testCreateNewItineraryReservation() {
		...
		ItineraryReservations itineraryReservationData = itineraryReservationsRepository.save(itineraryReservation);
		assertTrue((itineraryReservationData.getNumber_in_party() == 1) && (itineraryReservationData.getReservationId() > 0));
	}
}
